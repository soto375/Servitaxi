      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu shadow-lg p-3 mb-5 rounded" aria-labelledby="dropdownMenuButton">
          ...
          <li class="dropdown-item dropdown-header">
            <p>
              <?php 
                echo $this->session->userdata('usuario')['nombre']."<br>";
              ?>
            </p>
          </li>
          <!-- Menu Footer-->
          ...
          <div class="dropdown-footer d-flex text-sm">
            <a href="<?php echo base_url(); ?>admin/logout" class="ml-auto btn btn-danger" title="Cerrar sesión"><i class="fas fa-sign-out-alt"></i> Salir</a>
          </div>
        </ul>
      </li>
