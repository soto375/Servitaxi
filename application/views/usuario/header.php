...
<head>
  ...
  <title>Administración - ServiTaxi</title>
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/logo.jpg" type="image/jpg">
...
<div class="wrapper" >
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="ml-auto navbar-nav">
      <li class="nav-item ">
        <a href="#" class="nav-link text-ligh"><i class="rounded-circle fas fa-home"></i></a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu shadow-lg p-3 mb-5 rounded" aria-labelledby="dropdownMenuButton">
          ...
          <li class="dropdown-item dropdown-header">
            <p>
              <?php 
                echo $this->session->userdata('usuario')['primer_nombre']."<br>";
              ?>
            </p>
          </li>
          <!-- Menu Footer-->
          ...
          <div class="dropdown-footer d-flex text-sm">
            <a href="<?php echo base_url(); ?>usuario/logout" class="ml-auto btn btn-danger" title="Cerrar sesión"><i class="fas fa-sign-out-alt"></i> Salir</a>
          </div>
        </ul>
      </li>
