         ...
         <div class="col">
            <div class="card">
               <div class="card-header d-flex flex-column flex-md-row">
                  <a class="btn btn-success" href="<?php echo base_url().'registrar-candidato';?>"><i class="fa fa-plus"></i> Registrar Taxistas</a>
                     ...
                     <tbody>
                        <?php if(!empty($usuario)): ?>
                          <?php foreach ($usuario as $usuario ):?>
                            <tr>
                              <td>
                               <?php if(file_exists("./assets/archivos/taxista_id_".$usuario->_id.".jpg")): ?>
                                  <img style="width:40px; height:40px;" src="<?php echo base_url()."assets/archivos/taxista_id_".$usuario->_id.".jpg"; ?>" /> 
                                <?php else: ?>
                                  <img style="width:40px; height:40px;" src="<?php echo base_url()."assets/archivos/taxista_id_".$usuario->_id.".png"; ?>" /> 
                                <?php endif; ?>
                                </td>
                              <td class="" scope="row">
                              ...
                              <td class="btn-group">
                                <a class="btn btn-outline-primary" href="<?php echo base_url().'editar-candidato/'.$usuario->_id;?>"><i class="fas fa-pencil-alt"></i></a>

                                
                                <a class="btn btn-outline-danger btn-eliminar" href="<?php echo base_url().'eliminar-taxista/'.$usuario->_id;?>"  ><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
                        <?php endif; ?>
