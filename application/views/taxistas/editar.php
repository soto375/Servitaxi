...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Taxista <small class="text-sm">Editar</small></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
        ...
        <div class="col-12">
          <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title"><i class="fas fa-plus"></i> Editar</h3>
            </div>
            
            <form action="<?php echo base_url()."editar-datos-taxistas"; ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="col">
        ...
        <input id="cc" type="text" name="cc"  onkeypress="return onlyNumberKey(event)"class="form-control" value="<?php echo $usuario->cedula ?>">
      </div>
    ...
    <div class="row">
      <div class="col">
        ...
        <input id="correo" type="tel" onkeypress="return onlyNumberKey(event)" name="contacto" class="form-control" value="<?php echo $usuario->contacto ?>">
      </div>

      <div class="col">
        <label for="correo" class="form-label">Ingresos</label>
        <input id="correo" type="number" name="ingreso" class="form-control" value="<?php echo $usuario->ingreso ?>">
      </div>

      <div><label for="correo" class="form-label">Ganancia</label>
      <input id="correo" type="number" name="ganancia" class="form-control" value="<?php echo $usuario->ganancia ?>"></div>
    </div>
